...
public class Treasure extends Image{
    ...
    public Treasure(Body myBody, MainGame myGame, float width, float height) {

        //set the extended Image class to match the spike that GameScreen already made
        super(new TextureRegion(myGame.atlas.findRegion("Chest1")));
        ...
        //set the animation
        spikeAnimation = new Animation(SPIKE_FRAME_DURATION, game.atlas.findRegions("Chest1"));
